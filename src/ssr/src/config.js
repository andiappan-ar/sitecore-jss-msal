...
const i18n_1 = require("@sitecore-jss/sitecore-jss/i18n");
const httpAgents_1 = require("./httpAgents");
/**
...
httpAgents_1.httpAgentsConfig.setUpDefaultAgents(serverBundle);
...
const dictionaryService = new i18n_1.RestDictionaryService({
    apiHost,
    siteName: appName,
    apiKey,
    cacheTimeout: 60,
...
exports.config = {
    ...
    proxyOptions: {
        ...
        agent: httpAgents_1.httpAgentsConfig.getAgent(apiHost),
    ...
    onError: (_err, response) => {
        ...
        return {
            statusCode: 500,
            content: fs_1.default.readFileSync('error.html', 'utf8'),
        };
    },
    createViewBag: (_request, _response, _proxyResponse, layoutServiceData) => {
        ...
        const site = layoutServiceData.sitecore.context.site && layoutServiceData.sitecore.context.site.name;
        if (!site) {
            return {};
        }
