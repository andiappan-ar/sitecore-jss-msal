...
const sitecore_jss_proxy_1 = __importDefault(require("@sitecore-jss/sitecore-jss-proxy"));
...
server.use('/dist', express_1.default.static('dist', {
    ...
    server.all('*', function (req, res, next) {
        ...
        try {
            ...
            if (req.url.includes('/auth/signin') || req.url.includes('/auth/redirect') || req.url.includes('/auth/getSessionLogger')) {
                ...
                if ((_a = req === null || req === void 0 ? void 0 : req.session) === null || _a === void 0 ? void 0 : _a.isAuthenticated) {
...
server.use('*', (0, sitecore_jss_proxy_1.default)(config_1.config.serverBundle.renderView, config_1.config, config_1.config.serverBundle.parseRouteUrl));
server.listen(port, () => {
